...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		if (Robot.arms.getCurrentCommand() != null)
			SmartDashboard.putString("Arms Command", Robot.arms.getCurrentCommand().toString());
		...
		if (Robot.collector.getCurrentCommand() != null)
			SmartDashboard.putString("Collector Command", Robot.collector.getCurrentCommand().toString());
		...
		if (Robot.plunger.getCurrentCommand() != null)
			SmartDashboard.putString("Plunger Command", Robot.plunger.getCurrentCommand().toString());
		...
		if (Robot.shooterPivot.getCurrentCommand() != null)
			SmartDashboard.putString("ShooterPivot Command", Robot.shooterPivot.getCurrentCommand().toString());
	}
