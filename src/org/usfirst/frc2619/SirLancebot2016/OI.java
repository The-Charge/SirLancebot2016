...
public class OI {
    ...
    public OI() {
        ...
        highGoalResetButton = new JoystickButton(buttonBox, 6);
        highGoalResetButton.whenReleased(new DefaultPositionCG());
        prepHighGoalButton = new JoystickButton(buttonBox, 6);
        prepHighGoalButton.whenPressed(new PrepHighGoalCG());
        collectorOffButton = new JoystickButton(buttonBox, 5);
        collectorOffButton.whenReleased(new CollectorOffCG());
        collectorOnButton = new JoystickButton(buttonBox, 5);
        collectorOnButton.whenPressed(new CollectorOnCG());
        shooterDownButton = new JoystickButton(buttonBox, 14);
        shooterDownButton.whenPressed(new LowerShooter());
        armsUpButton = new JoystickButton(buttonBox, 10);
        armsUpButton.whenPressed(new LiftArms());
        feedRollersStop2 = new JoystickButton(buttonBox, 4);
        feedRollersStop2.whenReleased(new FeedRollersStop());
        feedRollersStop1 = new JoystickButton(buttonBox, 3);
        feedRollersStop1.whenReleased(new FeedRollersStop());
        wristUpButton = new JoystickButton(buttonBox, 9);
        wristUpButton.whenPressed(new WristUp());
        shooterUpButton = new JoystickButton(buttonBox, 11);
        shooterUpButton.whenPressed(new LiftShooter());
        spitBall = new JoystickButton(buttonBox, 4);
        ...
        prepShooterButton = new JoystickButton(buttonBox, 2);
