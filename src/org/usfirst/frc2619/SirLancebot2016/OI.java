...
public class OI {
    ...
    public JoystickButton readSpeedPotTrueButton;
    public JoystickButton readSpeedPotFalseButton;
    ...
    public OI() {
        ...
        readSpeedPotFalseButton = new JoystickButton(buttonBox, 8);
        readSpeedPotFalseButton.whenReleased(new ReadPotFalse());
        readSpeedPotTrueButton = new JoystickButton(buttonBox, 8);
        readSpeedPotTrueButton.whenPressed(new ReadPotTrue());
        ...
        SmartDashboard.putData("ReadPotFalse", new ReadPotFalse());
