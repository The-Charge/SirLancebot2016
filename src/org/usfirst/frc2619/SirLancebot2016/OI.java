...
public class OI {
    ...
    public JoystickButton collectorForwardSwitch;
    public JoystickButton wristDownSwitch;
    public JoystickButton armsDownSwitch;
    public JoystickButton shooterPivotDown;
    public JoystickButton wristUpSwitch;
    public JoystickButton armsUpSwitch;
    public JoystickButton shooterPivotUp;
    public JoystickButton collectorForwardOffSwitch;
    ...
    public OI() {
        ...
        collectorForwardOffSwitch = new JoystickButton(buttonBox, 12);
        collectorForwardOffSwitch.whileHeld(new CollectorOffCG());
        shooterPivotUp = new JoystickButton(buttonBox, 16);
        shooterPivotUp.whileHeld(new LiftShooter());
        armsUpSwitch = new JoystickButton(buttonBox, 15);
        armsUpSwitch.whenReleased(new LiftArms());
        wristUpSwitch = new JoystickButton(buttonBox, 14);
        wristUpSwitch.whenReleased(new WristUp());
        shooterPivotDown = new JoystickButton(buttonBox, 16);
        shooterPivotDown.whenReleased(new LowerShooter());
        armsDownSwitch = new JoystickButton(buttonBox, 15);
        ...
        collectorForwardSwitch.whenReleased(new EatBallCG());
        ...
        collectButton.whileHeld(new CollectCG());
        highGoalButton = new JoystickButton(buttonBox, 3);
        highGoalButton.whenPressed(new HighGoalCG());
        lowGoalButton = new JoystickButton(buttonBox, 2);
        lowGoalButton.whenPressed(new LowGoalCG());
        ...
        SmartDashboard.putData("HighGoalCG", new HighGoalCG());
        SmartDashboard.putData("CollectorOffCG", new CollectorOffCG());
