...
public class OI {
    ...
    public JoystickButton shooterOffSwitch;
    ...
    public OI() {
        ...
        shooterOffSwitch = new JoystickButton(buttonBox, 11);
        shooterOffSwitch.whileHeld(new ShooterOff());
        shooterPivotUp = new JoystickButton(buttonBox, 16);
        shooterPivotUp.whenReleased(new LiftShooter());
        ...
        shooterPivotDown.whileHeld(new LowerShooter());
