...
public class RobotMap {
    ...
    public static CANTalon intakeArmsOneMotorIntakeArmMotor;
    public static DoubleSolenoid intakeArmsPneumaticLeftIntakeArm;
    public static DoubleSolenoid intakeArmsPneumaticRightIntakeArm;
    ...
    public static void init() {
        ...
        ballScoopBallScooper = new DoubleSolenoid(0, 4, 5);
        LiveWindow.addActuator("Ball Scoop", "BallScooper", ballScoopBallScooper);
        
        intakeArmsOneMotorIntakeArmMotor = new CANTalon(1);
        LiveWindow.addActuator("IntakeArmsOneMotor", "IntakeArmMotor", intakeArmsOneMotorIntakeArmMotor);
        
        intakeArmsPneumaticLeftIntakeArm = new DoubleSolenoid(0, 6, 7);
        LiveWindow.addActuator("IntakeArmsPneumatic", "LeftIntakeArm", intakeArmsPneumaticLeftIntakeArm);
        
        intakeArmsPneumaticRightIntakeArm = new DoubleSolenoid(1, 2, 3);
        LiveWindow.addActuator("IntakeArmsPneumatic", "RightIntakeArm", intakeArmsPneumaticRightIntakeArm);
