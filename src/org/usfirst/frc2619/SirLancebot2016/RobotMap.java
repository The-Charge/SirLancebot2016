...
public class RobotMap {
    ...
    public static void init() {
        ...
        shooterleftShooterMotor = new WPI_TalonSRX(2);
        LiveWindow.addActuator("Shooter", "leftShooterMotor", shooterleftShooterMotor);
        
        shooterrightShooterMotor = new WPI_TalonSRX(1);
        ...
        collectorfeedRoller = new WPI_TalonSRX(3);
        LiveWindow.addActuator("Collector", "feedRoller", collectorfeedRoller);
        
        collectorcenterRoller = new WPI_TalonSRX(4);
