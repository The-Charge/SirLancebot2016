...
public class CrossLowBarCG extends CommandGroup {
	...
	public CrossLowBarCG() {
		...
		addSequential(new LowerArms()); // TODO: Test to see if the arms keep
										// lowering. Figure out how to stop
										// this.
		addSequential(new DriveXfeet(distanceFromStart));
		addSequential(new DriveUntilFlat(.5)); // TODO: Test this code for make
												// sure the robot clears the
												// lowbar
	}
}
