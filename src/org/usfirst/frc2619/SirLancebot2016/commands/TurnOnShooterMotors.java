 ...
 *
 */
public class TurnOnShooterMotors extends Command {
    ...
    protected void execute() {
    	...
    	if(Robot.shooterMotors.readfrompot)
    	{
    		Robot.shooterMotors.run();
    	}
    	else
    	{
    		Robot.shooterMotors.setDefaultSpeed(.5);
    	}
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
        return Robot.shooterMotors.shooterMotorsOn;
    }
