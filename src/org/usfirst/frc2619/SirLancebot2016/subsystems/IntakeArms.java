...
public class IntakeArms extends Subsystem {
    ...
    private final DoubleSolenoid leftIntakeArm = RobotMap.intakeArmsLeftIntakeArm;
    private final DoubleSolenoid rightIntakeArm = RobotMap.intakeArmsRightIntakeArm;
