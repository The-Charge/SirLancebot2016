...
public class VisionLights extends Subsystem {
    ...
    private final Relay visionSpike = RobotMap.visionLightsvisionSpike;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new VisionLightControl());
    ...
    {
    	visionSpike.set(Relay.Value.kForward);
    }
    
    public void lightsOff()
    {
    	visionSpike.set(Relay.Value.kReverse);
    }
}
