...
public class ShooterMotors extends Subsystem {
    ...
    public boolean readfrompot = false;
    ...
    public void setDefaultSpeed(double speed) // ONLY to be used to set default speed for TurnOnShooterMotors Command
    {
    	leftShooterMotor.set((int)(MathUtil.shooterSpeedFormat(Robot.oi.buttonBox.getZ()) * MAX_TICKS_PER_SECOND));
    	rightShooterMotor.set((int)(MathUtil.shooterSpeedFormat(Robot.oi.buttonBox.getZ()) * MAX_TICKS_PER_SECOND) * -1);
    }
}
