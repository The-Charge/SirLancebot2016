...
public class ShooterMotors extends Subsystem {
	...
	private final static double DEFAULT_INTAKE_PERCENTSPEED = .65;
	...
	public void writeDashboardDebugValues() {
		...
		TheChargeDashboard.putNumber("ShooterLeftSpeed",
				leftShooterMotor.getEncVelocity());
	...
	public void initSpeedMode() {
		leftShooterMotor.setControlMode(CANTalon.TalonControlMode.Speed
				.getValue());
		rightShooterMotor.setControlMode(CANTalon.TalonControlMode.Speed
				.getValue());
	}
