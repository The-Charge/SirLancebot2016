...
public class DriveTrain extends Subsystem {
	...
	double motorSpeedCalcDis() {
		if (!Robot.cameraSubsystem.onDistanceTarget())
			if (Robot.cameraSubsystem.getDistance() > CameraSubsystem.OPTIMAL_DISTANCE)
	...
	double motorSpeedCalcAng() {
		if (!Robot.cameraSubsystem.onAngleTarget())
			if (Robot.cameraSubsystem.getTargetXRotation() > 0.0)
