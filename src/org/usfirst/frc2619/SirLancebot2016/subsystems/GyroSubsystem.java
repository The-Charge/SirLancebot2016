...
public class GyroSubsystem extends Subsystem {
	...
	public void writeDashboardDebugValues() {
		...
		TheChargeDashboard
				.putBoolean("IMU_IsCalibrating", ahrs.isCalibrating());
		...
		TheChargeDashboard.putNumber("IMU_CompassHeading",
		...
		TheChargeDashboard
				.putNumber("IMU_Accel_X", ahrs.getWorldLinearAccelX());
		TheChargeDashboard
				.putNumber("IMU_Accel_Y", ahrs.getWorldLinearAccelY());
		...
		TheChargeDashboard.putString("YawAxisDirection", yaw_axis.up ? "Up"
				: "Down");
		TheChargeDashboard.putNumber("YawAxis", yaw_axis.board_axis.getValue());

		TheChargeDashboard.putString("FirmwareVersion",
		...
		TheChargeDashboard
				.putNumber("IMU_Updaate_Count", ahrs.getUpdateCount());
	}
