...
public class CameraSubsystem extends Subsystem {
	...
	private final static double ANGLE_DEADBAND = .5;
	private static double angle_deadband;
	private final static double DISTANCE_DEADBAND = .3;
	private static double distance_deadband;
	public double OPTIMAL_DISTANCE = 14.3;
	...
	public CameraSubsystem() {
		...
		seeTarget = new Timer();
		seeTarget.start();
		TheChargeDashboard.putNumber("OptimalDistance", Robot.cameraSubsystem.OPTIMAL_DISTANCE);
		TheChargeDashboard.putNumber("DistanceDeadband", DISTANCE_DEADBAND);
		TheChargeDashboard.putNumber("AngleDeadband", ANGLE_DEADBAND);
	}
	...
	public void writeDashboardDebugValues() {
		...
		OPTIMAL_DISTANCE = SmartDashboard.getNumber("OptimalDistance", OPTIMAL_DISTANCE);
		TheChargeDashboard.putNumber("OptimalDistance", Robot.cameraSubsystem.OPTIMAL_DISTANCE);
		distance_deadband = SmartDashboard.getNumber("DistanceDeadband", DISTANCE_DEADBAND);
		TheChargeDashboard.putNumber("DistanceDeadband", distance_deadband);
		angle_deadband = SmartDashboard.getNumber("AngleDeadband", ANGLE_DEADBAND);
		TheChargeDashboard.putNumber("AngleDeadband", angle_deadband);		
	}
