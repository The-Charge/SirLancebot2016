...
public class CameraSubsystem extends Subsystem {
	...
	public static final double OPTIMAL_DISTANCE = 13.5;
    ...
    public static double getTargetXRotation()
    {
    ...
    public static boolean onDistanceTarget()
    {
    	return ((getDistance() < OPTIMAL_DISTANCE + DISTANCE_DEADBAND) || (getDistance() > OPTIMAL_DISTANCE - DISTANCE_DEADBAND));
    }
    
    public static boolean onAngleTarget()
    {	
