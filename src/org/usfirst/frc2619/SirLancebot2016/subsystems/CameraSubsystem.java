...
public class CameraSubsystem extends Subsystem {
	...
	private final static double ANGLE_DEADBAND = .35;
	private final static double DISTANCE_DEADBAND = .4;
	public final double OPTIMAL_DISTANCE = 12.5;
