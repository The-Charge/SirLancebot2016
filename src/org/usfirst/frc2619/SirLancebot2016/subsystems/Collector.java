...
public class Collector extends Subsystem {
    ...
    public static final double FORWARD_SPEED_FEED = 1;
    public static final double FORWARD_SPEED_CENTER = 1;
    ...
    public void run()
    {
    	...
    	if(feedRollerOn && feedRollerForward)forwardRollers();
    	else if(feedRollerOn && !feedRollerForward)reverseRollers();
    	else stopRollers();
    }
