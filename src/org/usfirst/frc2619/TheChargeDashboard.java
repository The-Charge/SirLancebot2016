...
public class TheChargeDashboard {
	...
	private static String[] whiteList = {
			...
			/* DriveTrainAuon */
			"AutonDistance", "AutonSpeed","AutonDegrees",
			...
			/* Blinky Lights */ 
			//"LightSpike", "LEDState", "BallSensor", "Hasball", "hasBallBool", "ShooterUp",
			/* GyroSubsystem */
			"IMU_TotalYaw",
			//"IMU_Roll",
			//"IMU_Pitch",
			...
			/* Auton Bools */
			"AutonShiftHigh", "AutonArmsDown", "AutonPivotDown", 
			/* AutoAim Tuning Constants */ 
			//"AimDistanceSpeed", "AimAngleSpeed", "AimDistanceGain", "AimAngleGain"
			};
